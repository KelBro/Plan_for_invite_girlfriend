...
class Answer(db.Model):
    ...
    meeting_place = db.Column(db.String(255), nullable=True)
    answer6 = db.Column(db.Boolean)
    created_at = db.Column(db.DateTime, default=datetime.utcnow)

    user = db.relationship("User", back_populates="answer")
    foods = db.relationship("Food", secondary=answer_foods, back_populates="answers")
